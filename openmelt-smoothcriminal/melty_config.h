...
#define DEFAULT_ACCEL_MOUNT_RADIUS_CM 3.2         //Radius of accelerometer from center of robot
...
#define HEADING_LED_PIN	12                         //To heading LED (pin 13 is on-board Arduino LED)
